         ...
         onViewportEnter={()=> setSelectedPage(SelectedPage.Benefits)}>
            ...
            <motion.div className='md:my-5 md:w-3/5'
                ...
                <p className=' my-5 text-sm'>
                   ...
                   care into each other and evry member. 
                </p>
            </motion.div>
            {/*BENEFITS*/}
            <motion.div className='p-12 mt-5 items-center justify-between gap-8  md:flex'
                initial='hidden'
                whileInView='visible'
                viewport={{once:true,amount:0.5}}
                variants={container}
            ...
            <div className='mt-16 items-center justify-between gap-20 md:mt-28 md:flex'>
                ...
                <div>
                    ...
                    <div className='relative'>
                        <div className='before:absolute before:-top-32 before:-left-0 before:z-[1] before:content-abstractwaves'>
                            <motion.div
                             initial="hidden"
                             whileInView='visible'
                             viewport={{once:true, amount:0.5}}
